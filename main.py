...
4. is_replaceable: true ONLY if the syllabus EXPLICITLY states that component can be replaced by the final. If the syllabus says midterms are NOT replaceable, or makes no mention of replacement, set is_replaceable: false for ALL components and replacement_policy.enabled: false.
